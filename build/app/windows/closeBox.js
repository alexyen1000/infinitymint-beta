...
CloseBox.initialize = async (window, frame, blessed) => {
    ...
    window.registerElement("text", blessed.box({
        left: "center",
        top: "center",
        width: "shrink",
        height: "shrink",
    ...
    //create buttons
    let closeInfinityMint = window.registerElement("close", blessed.box({
        bottom: 2,
        left: 2,
        shrink: true,
        width: "shrink",
    ...
    let keepInfinityMint = window.registerElement("keepOpen", blessed.box({
        bottom: 2,
        right: 2,
        shrink: true,
        width: "shrink",
