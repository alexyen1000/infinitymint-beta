...
exports.isEnvSet =
	...
	exports.error =
	exports.saveSession =
	exports.saveSessionVariable =
	exports.getSolidityNamespace =
	exports.createInfinityMintConfig =
	exports.initializeGanacheMnemonic =
	exports.preInitialize =
	exports.readJson =
	exports.createDirs =
	exports.loadInfinityMint =
	exports.initializeInfinitymintConfig =
	exports.getProject =
	exports.getDeployedProject =
	exports.getCompiledProject =
	exports.getConfigFile =
	exports.overwriteConsoleMethods =
	exports.readSession =
	exports.debugLog =
	exports.log =
		void 0;
...
const readSession = () => {
	...
	try {
		return JSON.parse(
			fs_1.default.readFileSync(process.cwd() + "/.session", {
				encoding: "utf-8",
			})
		);
	} catch (error) {
...
const overwriteConsoleMethods = () => {
	...
	console.log = (msg, setPipe = true) => {
		...
		if (
			((_a = pipes_1.default.logs[pipes_1.default.currentPipe]) ===
				null || _a === void 0
				? void 0
				: _a.listen) ||
			(pipes_1.default.logs[pipes_1.default.currentPipe] === undefined &&
...
const initializeInfinitymintConfig = () => {
	...
	infinityMintConfig.hardhat.defaultNetwork =
		((_a = infinityMintConfig.hardhat) === null || _a === void 0
			? void 0
			: _a.defaultNetwork) ||
		((_b = session.environment) === null || _b === void 0
			? void 0
			: _b.defaultNetwork);
	...
	if ((0, exports.isEnvTrue)("SOLIDITY_USE_NODE_MODULE")) {
		if (
			fs_1.default.existsSync(process.cwd() + "/package.json") &&
			(0, exports.readJson)(process.cwd() + "/package.json").name ===
				"infinitymint"
		)
		...
		if (
			fs_1.default.existsSync(solidityFolder) &&
...
const createDirs = (dirs) => {
	dirs.filter((dir) => !fs_1.default.existsSync(dir)).forEach((dir) =>
		fs_1.default.mkdirSync(
			process.cwd() + (dir[0] !== "/" ? "/" + dir : dir)
		)
	);
};
...
const preInitialize = () => {
	...
	if (
		!fs_1.default.existsSync(process.cwd() + "/.env") &&
...
const initializeGanacheMnemonic = () => {
	...
	if (
		(0, exports.isEnvTrue)("GANACHE_EXTERNAL") === false &&
		((_a = session.environment) === null || _a === void 0
			? void 0
			: _a.ganacheMnemomic) === undefined
	)
	...
	(0, exports.saveSession)(session);
	return (_b = session.environment) === null || _b === void 0
		? void 0
		: _b.ganacheMnemomic;
};
