 ...
 * @param projectName
 */
export declare const getCompiledProject: (
	projectName: string
) => InfinityMintProject;
/**
 ...
 * @param projectName
 */
export declare const getDeployedProject: (
	projectName: string,
	version?: any
) => InfinityMintProject;
/**
...
) => InfinityMintProject | InfinityMintProjectJavascript;
/**
 ...
 */
export declare const loadInfinityMint: (
...
export declare const createInfinityMintConfig: (
	useJavascript?: boolean,
	useInternalRequire?: boolean
) => void;
export declare const getSolidityNamespace: () => any;
export declare const saveSessionVariable: (
