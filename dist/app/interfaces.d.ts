 ...
 */
export interface InfinityMintProjectEventParameters<T> extends InfinityMintDeploymentParameters, Dictionary<any> {
    event?: T;
 ...
 */
export interface InfinityMintEvents extends Dictionary<FuncSingle<InfinityMintProjectEventParameters<any>, Promise<void | boolean>>> {
    preCompile?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void | boolean>>;
    /**
     * Will be called when project is compiled
     */
    postCompile?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void>>;
    /**
     * Will be called when setup is about to take place. Can return false to abort setup silently.
     */
    preSetup?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void | boolean>>;
    postSetup?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void>>;
    /**
     * Will be called when deploy complete.
     */
    postDeploy?: FuncSingle<InfinityMintProjectEventParameters<Dictionary<InfinityMintDeploymentLive[]>>, Promise<void>>;
    preDeploy?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void | boolean>>;
    gemPreSetup?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintGemScript>, Promise<void>>;
    gemPostSetup?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintGemScript>, Promise<void | boolean>>;
    gemPreDeploy?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintGemScript>, Promise<void>>;
    gemPostDeploy?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintDeploymentLive | InfinityMintDeploymentLive[]>, Promise<void | boolean>>;
    postGems?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void>>;
    preGems?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void | boolean>>;
    postGem?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintGemScript>, Promise<void>>;
    preGem?: FuncSingle<InfinityMintProjectEventParameters<InfinityMintGemScript>, Promise<void | boolean>>;
    postExport?: FuncSingle<InfinityMintProjectEventParameters<string[]>, Promise<void>>;
    /**
     * Will be called when export is about to begin. Can return false to abort/skip export silently.
     */
    preExport?: FuncSingle<InfinityMintProjectEventParameters<string[]>, Promise<void | boolean>>;
    preBuild?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void | boolean>>;
    postBuild?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void>>;
    success?: FuncSingle<InfinityMintProjectEventParameters<void>, Promise<void>>;
    failure?: FuncSingle<InfinityMintProjectEventParameters<Error>, Promise<void>>;
}
/**
 ...
 */
export interface InfinityMintScriptParameters extends InfinityMintDeploymentParameters, Dictionary<any> {
    gems?: Dictionary<InfinityMintGemScript>;
