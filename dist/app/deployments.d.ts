 ...
 */
export declare const getNetworkDeployment: (
	contractName: string,
	network: string
) => InfinityMintDeploymentLive;
/**
 ...
 * @returns
 */
export declare const readNetworkDeployment: (
	contractName: string,
	network: string
) => any;
/**
 ...
 * @returns
 */
export declare const hasDeploymentManifest: (
	contractName: string,
	project: InfinityMintProject,
	network?: string
) => boolean;
export declare const getDeploymentClass: (
	contractName: string,
	project: InfinityMintProject,
	network?: string
) => InfinityMintDeployment;
export declare const getLiveDeployments: (
	contractName: string,
	project: InfinityMintProject,
	network: string
) => InfinityMintDeploymentLive[];
 ...
 * @returns
 */
export declare const getDeploymentClasses: (
	project: InfinityMintProject,
	network?: string,
	root?: string
