...
Menu.initialize = async (window, frame, blessed) => {
    ...
    background.setBack();
    let deploy = window.registerElement("deploy", blessed.box({
        bottom: 0,
        left: 0,
        shrink: true,
        width: "shrink",
    ...
    let test = window.registerElement("test", blessed.box({
        bottom: 0,
        left: 11,
        shrink: true,
        width: "shrink",
    ...
    window.registerElement("export", blessed.box({
        bottom: 0,
        left: 10 + 10,
        shrink: true,
        width: "shrink",
    ...
    let scripts = window.registerElement("scripts", blessed.box({
        bottom: 0,
        left: 10 + 8 + 13,
        shrink: true,
        width: "shrink",
    ...
    let projects = window.registerElement("projects", blessed.box({
        bottom: 0,
        left: 10 + 8 + 8 + 17,
        shrink: true,
        width: "shrink",
    ...
    let deployments = window.registerElement("deployments", blessed.box({
        bottom: 0,
        left: 10 + 8 + 8 + 8 + 22,
        shrink: true,
        width: "shrink",
    ...
    let networks = window.registerElement("networks", blessed.box({
        bottom: 0,
        left: 10 + 8 + 8 + 8 + 10 + 28,
        shrink: true,
        width: "shrink",
