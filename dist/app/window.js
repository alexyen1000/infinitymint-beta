...
class InfinityMintWindow {
    ...
    async updateFrameTitle() {
        ...
        this.getElement("frame").setContent(` {bold}${this.name}{/bold} | {yellow-fg}[${getAccountIndex}]{/yellow-fg} {underline}${defaultSigner.address}{/underline} | {magenta-bg}${hardhat_1.default.network.name}{/magenta-bg} | gas: {red-fg}50gwei{/red-fg} balance: {green-fg}${etherBalance} ETH{/green-fg} | Solidity Root: {cyan-fg}${(0, helpers_1.getSolidityFolder)()}{/cyan-fg}`);
    }
    async create() {
