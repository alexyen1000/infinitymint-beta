...
export const buildImports = async (
    ...
    for (let i = 0; i < infinityImports.length; i++) {
        ...
        imports.keys[cwd() + '/imports' + root + '/' + normalImport.name] =
            name;
        imports.keys[cwd() + '/imports' + root + '/' + normalImport.base] =
            name;
        imports.keys[
        ...
        imports.keys['/imports' + root + '/' + normalImport.base] = name;
        imports.keys[
            ('/imports' + root + '/' + normalImport.name).toLowerCase()
        ] = name;
        imports.keys[
            ('imports' + root + '/' + normalImport.base).toLowerCase()
        ] = name;
